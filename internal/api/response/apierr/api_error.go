...
var (
	...
	AuthInvalidUserId        = response.NewJsonResError(401_00_003, "鉴权失败,无效的userId")     // 鉴权失败,无效的userId
	...
	AuthUserIdMismatch       = response.NewJsonResError(401_00_006, "鉴权失败,userId与其凭证不匹配") // 鉴权失败,userId与其凭证不匹配
